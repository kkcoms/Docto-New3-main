...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: 'Create a clinical note of the clinical encounter.  Always, format it as markup with headings for the sections. It must be short an concise with paragraphs where needed, lists, bullet points and all that markup can support and line breaks where necessary. Do not provide a tittle heading for the note  just for the sections. Headings are always H3. You always return markup and headings are always H3. You only focus on the information that is clinically relevant. A section about suggestions and next steps should also be added among the other sections. It must be succinct when possible.'
  //         `Title the summary with an <h1> tag, applying the class "text-2xl font-bold" for prominent display. Provide a concise summary of the user's message focusing on the key points and action items, using a <p> tag with the class "text-base" for the body text.
  ...
  //           <li><strong>Subheading 1:</strong> [Issue/Action Item/Observation/Insights/Importance with brief explanation.]</li>
  //           <li><strong>Subheading 2:</strong> [Observation/Importance with brief explanation.]</li>
  //           <li><strong>Subheading 3:</strong> [Insights/Recent Developments with brief explanation.]</li>
  //         </ul>
  //         <br>
